      ...
      <div className="flex flex-row max-h-min w-full">
        <div className="leading-[2] md:flex md:flex-col lg:flex-row md:justify-between md:flex-grow w-full">
          <div className="xl:h-full flex flex-row justify-between w-full">
            ...
            <button
              className="relative transition duration-75 ease-out w-full h-2xl px-md rounded-xl outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-black antialiased text-black md:hidden max-w-min bg-white border border-sand hover:bg-chalk hover:border-chalk active:bg-chalk active:border-chalk"
              type="button"
            >
              <span className="flex items-center justify-center block font-semibold text-md">
                Copy
              </span>
            </button>
          </div>
